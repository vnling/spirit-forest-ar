...
public class GvrReticlePointer : MonoBehaviour
{
    ...
    public void OnPointerEnter(RaycastHit raycastHit, bool isInteractive)
    {
        SetPointerTarget(raycastHit.point, isInteractive);
    }
    ...
    public void OnPointerHover(RaycastHit raycastHit, bool isInteractive)
    {
        SetPointerTarget(raycastHit.point, isInteractive);
    }
    ...
    public void UpdateDiameters()
    {
      ...
      Mathf.Lerp(ReticleOuterDiameter, outer_diameter, Time.unscaledDeltaTime * reticleGrowthSpeed);
        ...
        MaterialComp.SetFloat("_InnerDiameter", ReticleInnerDiameter * MaxPointerDistance / 2f);
        MaterialComp.SetFloat("_OuterDiameter", ReticleOuterDiameter * MaxPointerDistance / 2f);
        MaterialComp.SetFloat("_DistanceInMeters", MaxPointerDistance);
    }
