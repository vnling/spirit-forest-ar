...
public class UIManager : MonoBehaviour
{
    ...
    public void Hide()
    {
        ...
        if (moveDeviceAnimation)
            moveDeviceAnimation.gameObject.SetActive(false);

        if (tapToPlaceAnimation)
            tapToPlaceAnimation.gameObject.SetActive(false);
    }
    ...
    public void Reset()
    {
        ...
        if (moveDeviceAnimation)
        {
            moveDeviceAnimation.gameObject.SetActive(true);
        ...
        if (tapToPlaceAnimation)
        {
            tapToPlaceAnimation.gameObject.SetActive(true);
            tapToPlaceAnimation.SetTrigger(k_FadeOffAnim);
        }
